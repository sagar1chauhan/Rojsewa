...
import { Plus, Search, Filter, Edit, Trash2, Eye, EyeOff, Settings2, Box, Layers } from "lucide-react";
...
const AdminServices = () => {
  ...
  // Rest of rendering logic... (truncated for clarity in thought, but full implementation below)
  return (
    <AdminLayout>
      <div className="mx-auto max-w-7xl space-y-6">
        <div className="flex flex-col md:flex-row gap-4 justify-between items-start">
          ...
          <button onClick={() => setShowModal(true)} className="px-5 py-3 bg-emerald-600 text-white rounded-2xl font-black flex items-center gap-2 shadow-lg shadow-emerald-600/20">
        ...
        <div className="grid grid-cols-1 gap-4">
          {services.map(service => (
            <div key={service.id} className="p-6 rounded-3xl border border-gray-200 bg-white shadow-sm hover:shadow-md transition">
              <div className="flex flex-col md:flex-row justify-between gap-6">
                ...
                <div className="flex-1 border-l border-dashed border-gray-200 pl-6">
                   <div className="flex justify-between items-center mb-4">
                      ...
                      <button 
                        ...
                        className="text-[10px] font-black underline text-blue-600"
                      >
                        + Add Dynamic Style
                      </button>
                   </div>
                   <div className="flex gap-2 flex-wrap">
                      {(service.addOns || []).length === 0 ? (
                        ...
                        service.addOns.map(addon => (
                          <div key={addon.id} className="group relative flex items-center gap-3 bg-gray-50 border border-gray-200 px-3 py-2 rounded-xl">
                  ...
                  <form onSubmit={handleAddItem} className="p-8 space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                       ...
                       <div>
                          ...
                          <select value={newItem.category} onChange={e => setNewItem({...newItem, category: e.target.value})} className="w-full mt-1 px-4 py-3 rounded-xl border border-gray-200 bg-gray-50 font-bold text-xs uppercase">
