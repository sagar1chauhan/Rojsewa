        ...
        <AdminLayout>
            <div className="space-y-6">
                <div className="flex justify-between items-end">
                    ...
                    <button className="px-4 py-2 bg-emerald-600 text-white rounded-xl text-sm font-bold shadow-md hover:bg-emerald-700 transition">Run Settlement Cycle</button>
                </div>
                ...
                <div className="rounded-2xl border border-border bg-white shadow-sm overflow-hidden mt-6">
                    <div className="px-6 py-4 border-b border-border bg-gray-50/50 flex items-center justify-between">
                        ...
                        <button className="text-xs font-bold text-emerald-600 bg-emerald-50 px-3 py-1.5 rounded border border-emerald-100">Export CSV</button>
                    </div>
