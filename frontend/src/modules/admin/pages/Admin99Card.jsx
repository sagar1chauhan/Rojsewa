    ...
    return (
        <AdminLayout>
            <div className="space-y-6">
                <div>
                    <h1 className="text-2xl font-black text-foreground">99 Card Management</h1>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="rounded-2xl border border-emerald-100 bg-gradient-to-br from-emerald-50 to-teal-50/50 p-6 shadow-sm">
                    ...
                    <div className="rounded-2xl border border-amber-100 bg-gradient-to-br from-amber-50 to-orange-50/50 p-6 shadow-sm">
                ...
                <div className="rounded-2xl border border-border bg-white shadow-sm overflow-hidden mt-8">
                            ...
                            <tbody className="divide-y divide-border">
                                {[
                                    ...
                                    <tr key={i} className="hover:bg-gray-50">
                                        ...
                                        <td className="px-6 py-4"><span className={`px-2.5 py-1 rounded-full text-xs font-bold ${item.free > 0 ? 'bg-emerald-100 text-emerald-700' : 'bg-gray-100 text-gray-500'}`}>{item.free > 0 ? `+${item.free} Added` : 'None'}</span></td>
