        ...
        <AdminLayout>
            <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                   <div className="p-5 rounded-2xl border border-border bg-white shadow-sm flex items-center gap-4">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <section className="rounded-2xl border border-border bg-white shadow-sm overflow-hidden">
                       <div className="p-4 border-b border-border bg-emerald-50/30 flex justify-between items-center">
                          <h3 className="font-black text-sm uppercase tracking-wider text-emerald-900">Vendor Score Matrix</h3>
                          <div className="flex items-center gap-2">
                             <Search className="h-3.5 w-3.5 text-gray-400" />
                             <input type="text" placeholder="Search provider..." className="text-[10px] bg-white border border-border px-2 py-1 rounded focus:outline-none focus:border-emerald-500" />
                          </div>
                       </div>
                       <div className="divide-y divide-border">
                          {[
