      ...
      <div className="mx-auto max-w-5xl space-y-6 lg:space-y-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="col-span-1 space-y-6">
            <div className="rounded-3xl border border-gray-200 bg-white p-6 shadow-sm flex flex-col items-center">
              ...
              <div className="w-full mt-8 space-y-4">
                 <div>
                   ...
                   <input type="text" value={adminProfile.name} onChange={e => setAdminProfile({...adminProfile, name: e.target.value})} className="block w-full rounded-xl border border-gray-200 bg-gray-50 py-2.5 px-3 text-sm font-semibold focus:border-emerald-500 focus:bg-white focus:outline-none" />
                 </div>
                 <div>
                   ...
                   <input type="email" value={adminProfile.email} onChange={e => setAdminProfile({...adminProfile, email: e.target.value})} className="block w-full rounded-xl border border-gray-200 bg-gray-50 py-2.5 px-3 text-sm font-semibold focus:border-emerald-500 focus:bg-white focus:outline-none" />
                 </div>
                 <div>
                   ...
                   <input type="text" value={adminProfile.phone} onChange={e => setAdminProfile({...adminProfile, phone: e.target.value})} className="block w-full rounded-xl border border-gray-200 bg-gray-50 py-2.5 px-3 text-sm font-semibold focus:border-emerald-500 focus:bg-white focus:outline-none" />
                 </div>
                 <button onClick={handleSaveProfile} className="w-full rounded-xl bg-white border border-gray-200 py-2.5 text-sm font-bold text-gray-700 hover:bg-gray-50 transition-colors shadow-sm mt-2">
                   Update Profile
                 </button>
              </div>
            </div>
